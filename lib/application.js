...
app.scopes = callbackSetter('scopes', app);
...
app.issueToken = callbackSetter('issueToken');
...
app.userByUsername = callbackSetter('userByUsername');
...
app.allowedUserScopes = callbackSetter('allowedUserScopes');
...
app.verifyPassword = callbackSetter('verifyPassword');
...
app.client = callbackSetter('client');
...
app.authorizationCode = callbackSetter('authorizationCode');
...
app.saveAuthorizationCode = callbackSetter('saveAuthorizationCode');
...
app.invalidateAuthorizationCode = callbackSetter('invalidateAuthorizationCode');
